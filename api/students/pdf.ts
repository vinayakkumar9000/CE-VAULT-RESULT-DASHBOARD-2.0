...
export default async function handler(
  ...
  try {
    ...
    // Find student by roll number - escape regex to prevent injection attacks
    ...
    // Generate PDF - wrap in Promise to ensure completion before function returns
    ...
    // Send response after PDF is fully generated
